...
#slide[
  ...
  #t2s(
    start_from: 1, speaker_id: 1,
  )[Our tool can convert Typst presentations generated by touying to a presentation video with AI voiceover.]
  #t2s(start_from: 2, speaker_id: 2,)[
...
#slide[
  ...
  #t2s(start_from: 1, speaker_id: 4)[
    You can also use some hacks to generate animations.
  ]
  #t2s(start_from: 2, speaker_id: 5)[Attention: this is a hack.]
